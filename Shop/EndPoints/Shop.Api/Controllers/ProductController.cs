...
public class ProductController : ApiController
{
    ...
    [HttpGet("{productId}")]
    public async Task<ApiResult<ProductDto>> GetPrdoductById(long productId)
    {
        return QueryResult(await _productFacade.GetProductById(productId));
    }
    ...
    {
        var result = await _productFacade.Create(new Application.Products.Create.CreateProductCommand()
        {
    ...
    [HttpDelete("images")]
    public async Task<ApiResult> RemoveImage(RemoveImageCommand command)
    {
    ...
    {
        var result = await _productFacade.Edit(new EditProductCommand(command.ProductId, command.Title, command.ImageFile,
