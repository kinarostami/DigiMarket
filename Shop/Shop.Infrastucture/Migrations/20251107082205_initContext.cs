        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingMethod_ShippingType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ShippingMethod_ShippingCost = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatgeoryId = table.Column<long>(type: "bigint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BaseDomainEvent", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BaseDomainEvent_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalSchema: "dbo",
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseDomainEvent_Comments_CommentId",
                        column: x => x.CommentId,
                        principalTable: "Comments",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseDomainEvent_Orders_OrderId",
                        column: x => x.OrderId,
                        principalSchema: "order",
                        principalTable: "Orders",
                        principalColumn: "Id");
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BaseDomainEvent_Sellers_SellerId",
                        column: x => x.SellerId,
                        principalSchema: "seller",
                        principalTable: "Sellers",
                        principalColumn: "Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseDomainEvent_CategoryId",
                table: "BaseDomainEvent",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseDomainEvent_CommentId",
                table: "BaseDomainEvent",
                column: "CommentId");

            migrationBuilder.CreateIndex(
                name: "IX_BaseDomainEvent_OrderId",
                table: "BaseDomainEvent",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BaseDomainEvent_SellerId",
                table: "BaseDomainEvent",
                column: "SellerId");
