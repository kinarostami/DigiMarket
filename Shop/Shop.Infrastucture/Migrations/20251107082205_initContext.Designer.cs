...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20251107082205_initContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Domain.BaseDomainEvent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Common.Domain.BaseDomainEvent", b =>
                {
                    ...
                    b.HasOne("Shop.Domain.CommentAgg.Comment", null)
                        .WithMany("DomainEvents")
                        .HasForeignKey("CommentId");

                    b.HasOne("Shop.Domain.OrderAgg.Order", null)
                        .WithMany("DomainEvents")
                    ...
                    b.HasOne("Shop.Domain.SellerAgg.Seller", null)
                        .WithMany("DomainEvents")
            ...
            modelBuilder.Entity("Shop.Domain.OrderAgg.Order", b =>
                {
                    ...
                    b.OwnsOne("Shop.Domain.OrderAgg.ValueObject.OrderDiscount", "Discount", b1 =>
                        {
                            b1.Property<long>("OrderId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Shop.Domain.OrderAgg.ValueObject.OrderShippingMethod", "ShippingMethod", b1 =>
                        {
                            b1.Property<long>("OrderId")
                                .HasColumnType("bigint");
